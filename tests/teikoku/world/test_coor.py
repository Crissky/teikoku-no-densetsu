import unittest
from teikoku.world.coor import Coordenate


class TestCoordenate(unittest.TestCase):

    def _make_coordenate(self, x=0, y=0):
        """Cria e retorna uma instância de Coordenate com valores padrão."""
